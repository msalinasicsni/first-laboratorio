 ...
 */
@Entity
@Table(name = "unidades", schema = "general", uniqueConstraints = @UniqueConstraint(columnNames = "CODIGO"))
public class Unidades implements Serializable{
	...
	public Unidades(long unidadId, String nombre, long tipoUnidad,
			Divisionpolitica municipio, EntidadesAdtvas entidadAdtva, char declaraSector,
	...
	public Unidades(long unidadId, String nombre, String razonSocial,
			String direccion, long tipoUnidad, Divisionpolitica municipio,
			EntidadesAdtvas entidadAdtva, char declaraSector, String telefono, String fax,
			String email, char grupoEconomico, long regimen, long categoria,
			BigDecimal longitud, BigDecimal latitud, char conectividad,
			long codigo, char pasivo, Date fechaRegistro,
