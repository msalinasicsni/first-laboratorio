...
public enum HealthUnitType {
    ...
    UnidadesPrimHosp("3,4,5,11,12,13,14,17,18,8,38,6,16,39,40"); // Se agregan 8,38,6,16 solicitados en capacitacion//29072019 se agrega tipo 39 según depuración MINSA (CMP del MINSA)//03092020 Se agrega 40  CENTRO NACIONAL ESPECIALIZADO para mostrar CNDR
