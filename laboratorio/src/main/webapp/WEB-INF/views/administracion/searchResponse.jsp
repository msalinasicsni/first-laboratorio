...
<body class="">
	...
	<div id="main" data-role="main">
		...
		<div id="ribbon">
			...
			<!-- breadcrumb -->
			<ol class="breadcrumb">
                <li><a href="<spring:url value="/" htmlEscape="true "/>"><spring:message code="menu.home" /></a> <i class="fa fa-angle-right"></i> <a href="<spring:url value="/administracion/respuestas/init" htmlEscape="true "/>"><spring:message code="menu.admin.respuestas" /></a></li>
			</ol>
			<!-- end breadcrumb -->
		...
		<div id="content">
			...
			<section id="widget-grid" class="">
				...
				<!-- end row -->
				<!-- row -->
				<div id="infoExa" hidden="hidden" class="row">
                                                ...
                                                <section class="col col-sm-6 col-md-6 col-lg-8">
                                                    ...
                                                    <div class="">
                                                        <label class="input">
                                                            ...
                                                            <input class="form-control" type="text" disabled id="nombreExamen2" name="nombreExamen2"/>
                                                        </label>
                                                    </div>
                                                </section>
