...
<div id="content">
    ...
    <section id="widget-grid" class="">
                ...
                <div class="jarviswidget jarviswidget-color-darken" id="wid-id-0">
                    ...
                    <div>
                        ...
                        <div class="widget-body no-padding">
                            ...
                            <input id="msg_response_cancel2" type="hidden" value="<spring:message code="msg.data.successfully.cancel"/>"/>
                            <input id="msg_response_added2" type="hidden" value="<spring:message code="msg.data.successfully.added"/>"/>
                            <input id="msg_response_updated2" type="hidden" value="<spring:message code="msg.data.successfully.updated"/>"/>
                            ...
                            <form id="dataDx-form" class="smart-form" autocomplete="off">
                                    ...
                                    <div class="row">
                                        ...
                                        <section class="col col-sm-6 col-md-6 col-lg-8">
                                            ...
                                            <div>
                                                <label class="input">
                                                    ...
                                                    <input class="form-control" type="text" disabled id="requestName" name="requestName" placeholder=" <spring:message code="lbl.desc.request" />">
                                                </label>
                                            </div>
                                        </section>
                                        ...
                                        <section class="col col-sm-6 col-md-6 col-lg-4">
                                            ...
                                            <div>
                                                <label class="input">
                                                    <i class="icon-prepend fa fa-pencil fa-fw"></i><i class="icon-append fa fa-sort-alpha-asc fa-fw"></i>
                                                    <input class="form-control" type="text" disabled name="area" id="area" placeholder=" <spring:message code="lbl.receipt.pcr.area" />"/>
                                                </label>
                                            </div>
                                        </section>
                                    </div>
                                ...
                                <footer>
                                    ...
                                    <div hidden="hidden" id="dButton2">
                                        <button type="button" id="btnAddConcept2" class="btn btn-primary styleButton" data-toggle="modal"
        ...
        <div class="row" hidden="hidden" id="div2">
        ...
        <div class="row" hidden="hidden" id="div3">
            <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <!-- Widget ID (each widget will need unique ID)-->
