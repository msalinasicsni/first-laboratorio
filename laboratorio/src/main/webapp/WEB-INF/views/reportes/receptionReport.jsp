...
<div id="ribbon">
    ...
    <!-- breadcrumb -->
    <ol class="breadcrumb">
        <li><a href="<spring:url value="/" htmlEscape="true "/>"><spring:message code="menu.home" /></a> <i class="fa fa-angle-right"></i> <a href="<spring:url value="/reports/reception/init" htmlEscape="true "/>"><spring:message code="menu.reception.report" /></a></li>
    </ol>
    <!-- end breadcrumb -->
...
<div class="row">
    ...
    <div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
        <h1 class="page-title txt-color-blueDark">
            ...
            <spring:message code="menu.reception.report" />
...
<c:url var="searchUrl" value="/reports/searchSamples"/>
<c:url var="exportUrl" value="/reports/expToPDF"/>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        handleInputMasks();
        $("li.receptionReport").addClass("open");
