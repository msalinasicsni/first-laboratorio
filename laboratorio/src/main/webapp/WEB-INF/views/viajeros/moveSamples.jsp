...
<div id="ribbon">
    ...
    <!-- breadcrumb -->
    <ol class="breadcrumb">
        <li><a href="<spring:url value="/" htmlEscape="true "/>"><spring:message code="menu.home" /></a> <i class="fa fa-angle-right"></i> <a href="<spring:url value="/sendMxReceipt/travelers" htmlEscape="true "/>"><spring:message code="menu.move.travelers" /></a></li>
    </ol>
    <!-- end breadcrumb -->
        ...
        <h1 class="page-title txt-color-blueDark">
            ...
            <spring:message code="lbl.send.receipt.orders.title" />
						<span> <i class="fa fa-angle-right"></i>
							<spring:message code="lbl.move.travelers" />
						</span>
        </h1>
    </div>
    <!-- end col -->
    ...
    <div class="jarviswidget jarviswidget-color-darken" id="wid-id-0">
        ...
        <div>
            ...
            <div class="widget-body no-padding">
                ...
                <input id="msg_confirm_t" type="hidden" value="<spring:message code="msg.confirm.title"/>"/>
                <input id="msg_confirm_c" type="hidden" value="<spring:message code="msg.move.confirm.content"/>"/>
                <input id="msg_move_succes" type="hidden" value="<spring:message code="msg.move.successfully"/>"/>
                <input id="msg_move_cancel" type="hidden" value="<spring:message code="msg.move.cancel"/>"/>
                ...
                <input id="msg_select_order" type="hidden" value="<spring:message code="msg.move.select.sample"/>"/>
...
<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
    ...
    <div class="jarviswidget jarviswidget-color-darken" id="wid-id-1">
        ...
        <div>
            ...
            <!-- widget content -->
            <div class="widget-body no-padding">
                <table id="receptions" class="table table-striped table-bordered table-hover" width="100%">
                    <thead>
                        <tr>
                ...
                <form id="move-samples-form" class="smart-form" autocomplete="off">
                    <fieldset>
                        <div class="row">
                                ...
                                <div class="input-group">
                                    ...
                                    <select id="labDestino" name="labDestino"
                                        ...
                                        <c:forEach items="${laboratorios}" var="laboratorio">
                                            <option value="${laboratorio.codigo}" selected>${laboratorio.nombre}</option>
                                        </c:forEach>
                                    </select>
                                </div>
                            </section>
                    ...
                    <footer>
                        <button type="submit" id="move_selected" class="btn btn-success btn-lg pull-right header-btn"><i class="fa fa-send"></i> <spring:message code="act.transfer.selected" /></button>
                    </footer>
                </form>
            </div>
            <!-- end widget content -->
...
<spring:url value="/resources/scripts/recepcionMx/moveTravelers.js" var="travelersjs" />
<script src="${travelersjs}"></script>
...
<c:url var="sSearchUrl" value="/sendMxReceipt/searchTravelers"/>
<c:url var="sMoveTravelers" value="/sendMxReceipt/moveTravelers"/>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var parametros = {
            ...
            sMoveTravelers : "${sMoveTravelers}",
            sTableToolsPath : "${tabletools}",
            blockMess: "${blockMess}",
            sPrintUrl: "${sPrintUrl}"
        };
        MoveTravelers.init(parametros);
        ...
        $("li.moveTravelers").addClass("active");
        if("top"!=localStorage.getItem("sm-setmenu")){
            $("li.moveTravelers").parents("ul").slideDown(200);
        }
    });
</script>
<!-- END JAVASCRIPTS -->
