        ...
        init: function (parametros) {
            ...
            jQuery.validator.addMethod("greaterOrEqualThan",
                function(value, element, params) {
                    ...
                    if (!/Invalid|NaN/.test(new Date(fecha1[2], fecha1[1]-1, fecha1[0]))) {
                        ...
                        }else { //si el otro campo de fecha esta vac�o y no es requerido
                            return true;
                        }
                    }
            ...
            $('#dx').change(function () {
                ...
                if (valor != null) {
                    ...
                    //validar si se deseleccion� un dx y existen datos agregados de �l en la p�gina, si es asi se deben eliminar
                    ...
                    //Si es covid, la fecha de toma debe ser la del d�a
