                ...
                $.getJSON(parametros.searchUrl, {
                    ...
                    if (len > 0) {
                        ...
                        for (var i = 0; i < len; i++) {
                            ...
                            table1.fnAddData(
                                [dataToLoad[i].codigoUnicoMx , dataToLoad[i].tipoMuestra, dataToLoad[i].fechaRecepcion, dataToLoad[i].calidad, dataToLoad[i].codSilais, dataToLoad[i].codUnidadSalud, dataToLoad[i].persona, dataToLoad[i].identificacion, dataToLoad[i].fechaNacimiento, dataToLoad[i].solicitudes, dataToLoad[i].factura, dataToLoad[i].usuario]);
